...
namespace Ktk.Model
{
    [RelationBackendName("Karton"), CacheMode(RelationCacheMode.Super)]
    public class Karton : Entity<int, Karton>
    {
        #region DAL
        ...
        public static List<Karton> ActiveList
        {
            get
            {
                return Schema.Kartons.Select("Active = @1", new SelectOptions("Name", SortOrder.Descending), true).Items;
            }
        }
    }
}