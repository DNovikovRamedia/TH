...
namespace Ktk.Model
{
    [RelationBackendName("Ads"), CacheMode(RelationCacheMode.Super)]
    public class Ad : Entity<int, Ad>
    {
        ...
        [Member("Brief"), MaximumLength(512), UiTitle("Текст баннера"), UiLocation(Location.Both)]
        ...
        public static List<Ad> GetList()
        {
            List<Ad> lads = Schema.Ads.Select("Active = @1",
                new SelectOptions("DateCreated", SortOrder.Descending),
